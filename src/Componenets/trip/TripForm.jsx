    ...
    <div className="min-h-screen bg-green-300 flex items-center justify-center px-4 py-8 josefin-sans">
      ...
      <div className="w-full max-w-3xl bg-white/90 backdrop-blur-lg p-8 sm:p-12 rounded-3xl shadow-2xl border border-gray-100">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="relative">
            ...
            >
              ...
              <option value="Bombay Picnic Spot">Bombay Picnic Spot</option>
            </select>
          </div>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4">
          <button
            onClick={() => navigate(-1)}
            className="flex items-center cursor-pointer justify-center gap-2 w-full sm:w-1/2 bg-gray-400 hover:bg-gray-500 text-white py-3 rounded-2xl font-semibold transition shadow-lg"
          >
          ...
          <button
            onClick={savePreview}
            className="w-full cursor-pointer sm:w-1/2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-3 rounded-2xl font-semibold hover:scale-105 transition shadow-lg"
          >
            Save & Preview →
          </button>
        </div>
